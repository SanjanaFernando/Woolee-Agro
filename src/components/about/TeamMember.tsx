  ...
  return (
    <div className="text-center">
      <div className="mb-4 relative group overflow-hidden rounded-xl">
        ...
        />
        <div className="absolute inset-0 bg-green-gradient opacity-0 group-hover:opacity-80 transition-opacity flex items-center justify-center">
      ...
      <h3 className="text-xl font-semibold text-green-dark mb-1">{name}</h3>
