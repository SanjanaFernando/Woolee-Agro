      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="aspect-square overflow-hidden bg-green-50 rounded-md">
              <img
                src={product.image}
                alt={product.name}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <span className="font-bold text-2xl text-[#63b516]">
                  ${product.price.toFixed(2)}
                </span>
                {product.originalPrice && (
              ...
              <div className="flex gap-2 mt-2">
                <Button
                  className="flex-1 bg-[#63b516] hover:bg-[#559d14] text-white text-sm py-2 shadow-md"
                  size="sm"
                  onClick={(e) => {
                    e.stopPropagation();
                    e.preventDefault();
